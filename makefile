...
gen_delete: ## Generates the assets
	@echo "╠ Generating the assets..."
	@flutter pub get
	@flutter pub run build_runner build --delete-conflicting-outputs

build_gen: ## Generates the assets
	@echo "╠ Generating files..."
	@flutter pub run build_runner build

build_gen_conflict: ## Generates the assets
	@echo "╠ Generating files..."
	@flutter pub run build_runner build --delete-conflicting-outputs 
...
build_apk_prod: ## Runs the mobile application in production
	@flutter clean
	@flutter pub get
...
build_ipa_prod: ## Builds the ipa in prod
	@flutter clean
	@flutter pub get
	@flutter build ipa --no-tree-shake-icons --flavor production -t lib/main_production.dart

...
PaymentRequestUser _$PaymentRequestUserFromJson(Map<String, dynamic> json) => PaymentRequestUser(
      id: (json['id'] as num?)?.toInt(),
      name: json['name'] as String?,
      profilePicture: json['profile_picture'] as String?,
    );

Map<String, dynamic> _$PaymentRequestUserToJson(PaymentRequestUser instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'profile_picture': instance.profilePicture,
    };

PaymentRequestItem _$PaymentRequestItemFromJson(Map<String, dynamic> json) => PaymentRequestItem(
      id: (json['id'] as num?)?.toInt(),
      name: json['name'] as String?,
...
Map<String, dynamic> _$PaymentRequestItemToJson(PaymentRequestItem instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
...
PaymentRequest _$PaymentRequestFromJson(Map<String, dynamic> json) => PaymentRequest(
      id: (json['id'] as num?)?.toInt(),
      ...
      requester: json['requester'] == null
          ? null
          : PaymentRequestUser.fromJson(json['requester'] as Map<String, dynamic>),
      ...
      acceptedAt:
          json['accepted_at'] == null ? null : DateTime.parse(json['accepted_at'] as String),
      declinedAt:
          json['declined_at'] == null ? null : DateTime.parse(json['declined_at'] as String),

        ...
        children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextField(
                      ...
                      descriptionText: cubit.state.workTitle.displayError?.message,
                    ),
                    12.verticalSpace,
                    Row(
                    ...
                    BlocBuilder<SellerWorksCubit, SellerWorksState>(
                      builder: (context, state) {
                        ...
                        return DropdownButtonFormField<WorkCategory>(
                          initialValue: state.selectedWorkCategory,
                    ...
                    CustomTextField(
                      ...
                      isError: cubit.state.price <
                              (AppHelper.appSettings(context).minBookingAmount ?? 0) ||
                          cubit.state.price >
                              (AppHelper.appSettings(context).maxBookingAmount ?? 0),
                    ...
                    BlocBuilder<SellerWorksCubit, SellerWorksState>(
                      builder: (context, state) {
                        ...
                        return DropdownButtonFormField<int>(
                          initialValue: state.durationInHours > 0 ? state.durationInHours : null,
                    ...
                    CustomTextField(
                      ...
                      hint: 'Describe the work, techniques and any special detail',
                      maxLines: 4,
                      onChanged: cubit.onDescriptionChanged,
                      isError: cubit.state.workDescription.isNotValid,
                      descriptionText: cubit.state.workDescription.displayError?.message,
                    ),
                    12.verticalSpace,
                    MultiDocumentPicker(
                      label: 'Media',
                      ...
                      children: List.generate(
                        ...
                        (index) => SizedBox.square(
                          ...
                          child: Stack(
                            ...
                            children: [
                              SizedBox.expand(
                                child: cubit.state.workFilePaths[index].isLocalFilePath
                                    ? Image.file(
                                    ...
                                    : CachedNetworkImage(
                                        imageUrl:
                                            cubit.state.workFilePaths[index].completeImagePath(),
                                        fit: BoxFit.cover,
          ...
          Container(
            ...
            child: BlocListener<SellerWorksCubit, SellerWorksState>(
              listenWhen: (previous, current) => previous.addWorkState != current.addWorkState,
              listener: (context, state) async {
                ...
                if (state.addWorkState.hasError) {
                  AppHelper.showAppDialog<void>(
                    ...
                    OnFailDialogContent(
                      subtext:
                          (state.addWorkState.error! as RemoteException).errorResponse?.message ??
                              '',
                      onDoneCallback: (_) {},
                    ),
                  );

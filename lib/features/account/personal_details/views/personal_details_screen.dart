...
import 'package:snip_fair/features/account/personal_details/cubit/personal_details_cubit.dart';
...
class PersonalDetailsScreen extends StatelessWidget
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<PersonalDetailsCubit, PersonalDetailsState>(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  20.verticalSpace,
                  BlocSelector<PersonalDetailsCubit, PersonalDetailsState,
                      StringInput>(
                    selector: (state) {
  ...
  Widget wrappedRoute(BuildContext context) {
    final currentProfile =
        context.read<SellerProfileMgtCubit>().state.profileDetails.data ??
            StylistProfileDetails();
    return BlocProvider(
      create: (context) => getIt<PersonalDetailsCubit>()
